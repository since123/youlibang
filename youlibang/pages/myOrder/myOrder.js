...
//     let ifPassword = this.data.ifPassword
//     let ifxianxia = this.data.ifxianxia
//     let 
//     if (payway == 'qianbaoPayfor') {
//       ifPassword= !ifPassword
//       this.setData({
//         ifPassword: ifPassword
//       })
//     } else if (payway == 'underLinePayfor'){
//       this.setData({
//         ifxianxia: ifxianxia,
//       })
//     }
...
//     } else if (this.data.payway == 'qianbaoPayfor'){
//       this.confirmQianbaoPay()
//     }
//     else {
...
//         'Accept': 'application/json'
//       },
//       url: ApiUrl.phplist + 'member/confirmPsw?token=' + wx.getStorageSync('token'),
//     }).then((res) => {
//       console.log(res)
//     })
//   },
